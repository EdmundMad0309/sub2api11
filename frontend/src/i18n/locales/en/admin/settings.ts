    ...
    settings: {
      ...
      features: {
        excelBpsImages: {
          ...
          budgetHint: 'The shared budget must be at least eight times the body limit. The effective budget is the greater of this value and the in-flight cap × 8 MiB; 512 slots mean at least 4096 MiB of budget, not actual memory usage. The cap defaults to 32 (range 1–512) and applies immediately after saving.',
