    ...
    settings: {
      ...
      features: {
        excelBpsImages: {
          ...
          capacityHint: '开启后, OpenAI/Composite 的 Responses, Chat 和 Messages HTTP 请求(含纯文本)受 64 MiB 请求体上限, 共享资源预算及在途请求数限制. 大请求可用并发更低, 超额返回 503, 不在内存中排队. 这些限制不代表 200 并发容量承诺.',
          maxRequests: '最大在途请求数',
          maxRequestsHint: '同时处理的上限, 超出立即返回 503. 默认 32, 范围 1-512, 保存后立即生效.',
